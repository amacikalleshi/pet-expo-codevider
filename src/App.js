...
//import {BrowserRouter as Router, Route, Switch, Link } form 'react-router-dom';
import './App.css';
  ...
  return (
    <div>
      <header>
        <h1>Pet Expo</h1>
        <nav>
          <button onClick={() => setType('about')}>About Us</button>
          <button onClick={() => setType('contact')}>Contact Us</button>
